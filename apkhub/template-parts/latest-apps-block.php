...
<div class="apkhub-latest-sec">
    <div class="apkhub-section-header">
        <div class="apkhub-heading"><h2>Latest Apps</h2></div>
        <div class="apkhub-btn"><a href="<?php echo site_url() . '/apkcat/apps'; ?>"><?php esc_attr_e(get_theme_mod('apkhub_home_viewmore_btn_text','View all')); ?></a></div>
    </div>
